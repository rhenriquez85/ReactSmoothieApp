...
const dataController = function() {
    ...
    this._updateData = () => {
        this._data = [
            ...
            { title: 'Mt. Tartarus', price: 14, img: tartarus, menuType: 'bites', description: 'The deeper you go, the higher we climb. Bottomless tater tots. First to the top is on us!' },
